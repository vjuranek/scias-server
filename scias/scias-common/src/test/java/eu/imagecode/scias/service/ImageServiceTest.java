...
import eu.imagecode.scias.util.Resources;
...
public class ImageServiceTest {
    ...
    @Rule
    public WeldInitiator weld = WeldInitiator.from(ImageService.class, Resources.class, Logger.class).build();
    ...
    public void testUploadImage() throws Exception {
        ...
        ImageService imgService = weld.select(ImageService.class).get();
